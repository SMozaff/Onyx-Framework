-- Down migration for 20260101000000_initial_schema.
-- Not specified by Team Prompt 2 (which only froze the "up" DDL); added
-- so `sqlx migrate` has a reversible pair, per standard sqlx practice.
